...
export default function ActivitySelector({ itinerary, sessionId, apiBase, budget, durationDays, travelMonth, onBack, onGenerate }) {
        ...
        try {
            const res = await fetch(`${apiBase}/generate-packages`, {
                ...
                body: JSON.stringify({
                    ...
                    travel_month: travelMonth || "December",
